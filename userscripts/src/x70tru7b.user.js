...
// @description  Unlocks some client-side vip features (advanced filters, filter-by-terms, "more" buttons on dashboard, rewatching, bulk list management, Turbo page nav and more).
// @version      1.0.0
// @namespace    x70tru7b
