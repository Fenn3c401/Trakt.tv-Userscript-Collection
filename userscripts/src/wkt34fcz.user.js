...
// @description  Adds custom links to all the "Watch-Now" and "External" sections (for titles and people). The ~35 defaults include Letterboxd, Stremio, streaming sites (e.g. P-Stream, Hexa-Watch), torrent aggregators (e.g. EXT, Knaben), various anime sites (both for streaming and tracking) and much more. Easily customizable.
// @version      0.6.5
// @namespace    wkt34fcz
...
const customWatchNowLinks = [
  ...
  {
    buildHref: (i) => `https://hexa.watch/watch${customLinkHelperFns.getDefaultDirectStreamingPath(i)}`,
